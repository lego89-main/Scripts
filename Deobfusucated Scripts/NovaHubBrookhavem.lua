...
local Libary = loadstring(game:HttpGet("https://raw.githubusercontent.com/shhskshdjsjsjsh-source/RedzHubUI/refs/heads/main/README.md"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = "Nova Hub v2.05",
    SubTitle = "by: Nexustester",
    LoadText = "Carregando Nova Hub",
    Flags = "NovaHub_Brookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://109878868794551", BackgroundTransparency = 0 },
...
InfoTab:AddParagraph({ "Creditos:", "Nexustester" })
InfoTab:AddParagraph({ "Colaborações:", "Nexustester" })
InfoTab:AddParagraph({ "Você está usando:", "Nova Hub brookhavem" })
