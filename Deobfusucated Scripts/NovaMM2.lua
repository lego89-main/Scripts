...
do
    ...
    WindUI:Popup(
        {
            Title = gradient("Nova Hub Loaded! for Murder Mystery 2", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
            Icon = "user",
            Content = gradient("Premium @ discord.gg/qbUPXCtssz", Color3.fromHex("#ffffff"), Color3.fromHex("#b0b0b0")) ..
                gradient("Nova Hub OFFICIAL", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
            Buttons = {
                {Title = gradient("Cancel", Color3.fromHex("#808080"), Color3.fromHex("#404040")), Callback = function()
                    end, Variant = "Tertiary"},
                {Title = gradient("Load", Color3.fromHex("#c0c0c0"), Color3.fromHex("#ffffff")), Callback = function()
                        Confirmed = true
    ...
    WindUI:Notify(
        {
            Title = gradient("Nova Hub", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
    ...
    local Window =
        WindUI:CreateWindow(
        {
            Title = gradient("Nova Hub - MM2 (Beta)", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
            Icon = "star",
            Author = gradient("Nexustester", Color3.fromHex("#808080"), Color3.fromHex("#c0c0c0")),
            Folder = "WindUI",
    ...
    Window:EditOpenButton(
        {
            ...
            StrokeThickness = 2,
            Color = ColorSequence.new(Color3.fromHex("1a1a1a"), Color3.fromHex("4a4a4a")),
            Draggable = true
        }
    )
    local Tabs = {
        ...
        InnocentTab = Window:Tab(
            {Title = gradient("INNOCENT", Color3.fromHex("#000000"), Color3.fromHex("#808080")), Icon = "circle"}
        ),
        MurderTab = Window:Tab(
            {Title = gradient("MURDER", Color3.fromHex("#000000"), Color3.fromHex("#808080")), Icon = "circle"}
        ),
        SheriffTab = Window:Tab(
            {Title = gradient("SHERIFF", Color3.fromHex("#000000"), Color3.fromHex("#808080")), Icon = "circle"}
        ),
        gh = Window:Divider(),
    ...
    Tabs.CharacterTab:Section({Title = gradient("Walkspeed", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    ...
    Tabs.CharacterTab:Section({Title = gradient("JumpPower", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    Tabs.CharacterTab:Slider(
    ...
    Tabs.EspTab:Section({Title = gradient("Special ESP", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    Tabs.EspTab:Toggle(
        {
            Title = gradient("Higlight Murder", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
            Default = false,
    ...
    Tabs.EspTab:Toggle(
        {
            Title = gradient("Highlight Innocent", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
            Default = false,
            Callback = function(state)
    ...
    Tabs.EspTab:Toggle(
        {
            Title = gradient("Highlight Sheriff", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
            Default = false,
            Callback = function(state)
    ...
    Tabs.EspTab:Toggle(
        {
            Title = gradient("GunDrop Highlight", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
            Default = false,
            Callback = function(state)
    ...
    Tabs.TeleportTab:Section({Title = gradient("Default TP", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    ...
    local function teleportToPlayer()
        if (teleportTarget and teleportTarget.Character) then
            ...
            WindUI:Notify(
                {Title = "Nova Hub", Content = "Target not found or unavailable", Icon = "x-circle", Duration = 3}
            )
        end
    end
    ...
    Tabs.TeleportTab:Section({Title = gradient("Special TP", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    ...
    Tabs.AimbotTab:Section({Title = gradient("Default AimBot", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    RoleDropdown =
    ...
    Tabs.AimbotTab:Section(
        {Title = gradient("Silent Aimbot (On rework)", Color3.fromHex("#000000"), Color3.fromHex("#808080"))}
    )
    local AutoFarm = {
        Enabled = false,
        Mode = "Teleport",
    ...
    Tabs.AutoFarm:Section({Title = gradient("Coin Farming", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    ...
    Title = gradient("Instead Unlock Emote", Color3.fromHex("#000000"), Color3.fromHex("#808080"))
})
...
Tabs.MainTab:Button({
    ...
    Tabs.MurderTab:Section({Title = gradient("Kill Functions", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    ...
    Tabs.SheriffTab:Section({Title = gradient("Shot functions", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    ...
    Tabs.SheriffTab:Section({Title = gradient("Shot Button", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    Tabs.SheriffTab:Button(
    ...
    Tabs.SettingsTab:Section({Title = gradient("Hitboxes", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    ...
    Tabs.SettingsTab:Section(
        {Title = gradient("Character Functions", Color3.fromHex("#000000"), Color3.fromHex("#808080"))}
    )
    Tabs.SettingsTab:Toggle(
    ...
    Tabs.SettingsTab:Section({Title = gradient("Auto Execute", Color3.fromHex("#000000"), Color3.fromHex("#808080"))})
    local AutoInject = {
        Enabled = false,
    ...
    Tabs.SocialsTab:Paragraph(
        {
            Title = gradient("Nova Hub - discord.gg/qbUPXCtssz", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
            Desc = "Our Discord Server",
            Image = "star",
            Color = "Gray",
            Buttons = {
                {
                    Icon = "circle",
                    Title = "Nova Hub DISCORD",
                    Callback = function()
                        if pcall(setclipboard, "https://discord.gg/qbUPXCtssz") then
                            WindUI:Notify(
                                {
                                    Title = "Copied!",
    ...
    Tabs.SocialsTab:Paragraph(
        {
            Title = gradient("Credits: Nexustester", Color3.fromHex("#000000"), Color3.fromHex("#808080")),
